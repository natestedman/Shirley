...
/// Applies a transform to a session's values, creating a new session. This type is wrapped in `Session` before being
/// returned publically.
internal struct TransformValueSession<Request, Value, Error: ErrorType>
{
    // MARK: - Initialization
...
extension TransformValueSession: SessionType
{
    // MARK: - SessionType
